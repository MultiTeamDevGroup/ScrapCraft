...
public class HammerItem extends ToolItem {
    ...
    public HammerItem(IItemTier tier, int attackDamage, float attackSpeed, Item.Properties properties) {
        super((float) attackDamage, attackSpeed, tier, DIGGABLES, properties.addToolType(net.minecraftforge.common.ToolType.PICKAXE, tier.getLevel()));
    }

    public boolean isCorrectToolForDrops(BlockState state) {
        int harvestLevel = this.getTier().getLevel();
