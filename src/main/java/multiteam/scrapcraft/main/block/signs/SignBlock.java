package multiteam.scrapcraft.main.block.signs;
...
public class SignBlock extends Block {
    ...
    protected static final VoxelShape SHAPE = Block.box(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D);

    public SignBlock(Properties p_i48440_1_) {
        super(p_i48440_1_);
